...
function Warning() {
  return (
    <div className="bg-slate-50 py-32 px-10 text-center text-gray-700 text-base">
      This feature isn&apos;t available due to limited banking API support in India. <br />
      A demo version will be added soon.
    </div>
  );
}
